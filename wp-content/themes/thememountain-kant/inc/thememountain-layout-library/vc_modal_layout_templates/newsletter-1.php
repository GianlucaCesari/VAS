...
$thememountain_data['name'] = esc_html__( "Newsletter 1", "thememountain-kant" );
$thememountain_data['weight'] = 0;
$thememountain_data['custom_class'] = 'vc_modal_layout_templates tm-tmp_newsletter-1 tm-tmp-category_newsletter';
