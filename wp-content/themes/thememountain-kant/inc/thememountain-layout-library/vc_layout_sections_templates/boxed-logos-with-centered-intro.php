...
$thememountain_data['name'] = esc_html__( "Boxed logos with centered intro", "thememountain-kant" );
$thememountain_data['weight'] = 0;
$thememountain_data['custom_class'] = 'vc_layout_sections_templates tm-tmp_boxed-logos-with-centered-intro tm-tmp-category_logos';
