...
$thememountain_data['name'] = esc_html__( "Special Hero 6", "thememountain-kant" );
$thememountain_data['weight'] = 0;
$thememountain_data['custom_class'] = 'vc_layout_sections_templates tm-tmp_special-hero-6 tm-tmp-category_special-hero-6';
