...
$thememountain_data['custom_class'] = 'vc_footer_layout_templates tm-tmp_3-col-footer-with-subscribe-form tm-tmp-category_three-columns';
$thememountain_data['content'] = <<<CONTENT
[vc_row columns_on_tablet="force_2" padding_top="80" padding_bottom="0"][vc_column h_text_align="left" h_text_align_mobile="left" v_align="v-align-middle" width="6/12"][tm_textblock textarea_html_bkg_color="#ffffff"]
<h4>Kant OnePage</h4>
