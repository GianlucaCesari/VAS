...
$thememountain_data['name'] = esc_html__( "Contact Style Three", "thememountain-kant" );
$thememountain_data['weight'] = 0;
$thememountain_data['custom_class'] = 'vc_layout_templates tm-tmp_contact-style-three tm-tmp-category_contact-pages';
