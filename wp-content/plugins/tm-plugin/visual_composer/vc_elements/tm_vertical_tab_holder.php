...
vc_map( array(
	"name" => esc_html__( 'Vertical Tabs', 'thememountain-plugin' ),
	'base' => 'tm_vertical_tab_holder',
	'show_settings_on_create' => true,
	'is_container' => true,
	'icon' => 'tm_vc_icon_tabs_vertical',
	...
	'custom_markup' => TM_Vc::tabs_custom_markup('tabs_vertical',esc_html__( 'Vertical Tabs', 'thememountain-plugin' )),
