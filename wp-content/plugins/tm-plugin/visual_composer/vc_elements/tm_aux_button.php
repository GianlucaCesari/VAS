 ...
 * tm_aux_button
 *
 * vc_map_button array is defined in vc_elements/tm_aux_button.php
 *
 * @since      1.0
 *
 * @uses       ThemeMountain\TM_Vc::$vc_elements_variable['vc_map_button']
 *
 * @see        tm_button
...
vc_map(array(
	...
	'base' => 'tm_aux_button',
	'as_child' => array('only' => 'tm_parallax,tm_fullscreen_presentation_item'),
	'is_container' => false,
...
class WPBakeryShortCode_tm_aux_button extends WPBakeryShortCode {}