...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'value' => array( esc_html__( 'Use zoom button', 'thememountain-plugin' ) => 'true' ),
			'std' => '',
			'dependency' => array('element' => 'link_icon','value'=>'use_lightbox'),
		...
		array(
			...
			'value' => array( esc_html__( 'Use share button', 'thememountain-plugin' ) => 'true' ),
			'std' => '',
			'dependency' => array('element' => 'link_icon','value'=>'use_lightbox'),
		...
		array(
			...
			'type' => 'dropdown',
			'heading' => esc_html__( 'Icon Animation Type', 'thememountain-plugin' ),
		...
		array(
			'group' => esc_html__( 'Animation', 'thememountain-plugin' ),
			'type' => 'textfield',
			'heading' => esc_html__( 'Icon Animation Duration', 'thememountain-plugin' ),
		...
		array(
			'group' => esc_html__( 'Animation', 'thememountain-plugin' ),
			'type' => 'textfield',
			'heading' => esc_html__( 'Icon Animation Delay', 'thememountain-plugin' ),
...
class WPBakeryShortCode_tm_slider_icon extends WPBakeryShortCode {}