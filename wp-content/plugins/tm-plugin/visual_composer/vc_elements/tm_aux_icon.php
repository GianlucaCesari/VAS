 ...
 * @since      1.0
 *
 * @uses       ThemeMountain\TM_Vc::$vc_elements_variable['vc_map_icon']
 *
 * @see        tm_icon
 * @see        tm_slider_icon Animation added
 */
...
class WPBakeryShortCode_tm_aux_icon extends WPBakeryShortCode {}