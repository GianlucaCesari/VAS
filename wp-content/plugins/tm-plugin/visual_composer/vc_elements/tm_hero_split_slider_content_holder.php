...
/**
 * tm_hero_split_slider_content_holder
 *
 * @since      1.1
 */
 ...
 */
vc_map( array(
	'name' => esc_html__( 'Split Hero Slider and Content', 'thememountain-plugin' ),
	'category' => esc_html__( 'ThemeMountain', 'thememountain-plugin' ),
	'base' => 'tm_hero_split_slider_content_holder',
	'icon' => 'tm_vc_icon_hero-5_slider_image_content',
	'class' => 'tm_element_tab_holder',
	'is_container' => true,
	"as_parent" => array('only' => 'tm_hero_split_slider_content_item'),
	'show_settings_on_create' => true,
	'description' => sanitize_text_field( 'Sliding images & content', 'thememountain-plugin' ) ,
	'params' => array(
		array(
			'type' => 'dropdown',
	...
	'custom_markup' => TM_Vc::tabs_custom_markup('hero-5_slider_image_content',esc_html__( 'Hero Split Slider', 'thememountain-plugin' )),
	'default_content' => '[tm_hero_split_slider_content_item title="' . esc_html__( 'Slide', 'thememountain-plugin' ) . '" tab_id="' . $tab_id_1 . '"][/tm_hero_split_slider_content_item]',
	'js_view' => 'TmTabsView'
) );

require_once vc_path_dir( 'SHORTCODES_DIR', 'vc-tabs.php' );

class WPBakeryShortCode_tm_hero_split_slider_content_holder extends WPBakeryShortCode_tm_tab_holder {
	...
	protected function getFileName() {
		return 'tm_hero_split_slider_content_holder';
	}

	public function getTabTemplate() {
		return '<div class="wpb_template">' . do_shortcode( '[tm_hero_split_slider_content_item title="Slide" tab_id=""][/tm_hero_split_slider_content_item]' ) . '</div>';
	}
}