<?php
/**
	ThemeMountain tm_carousel_slider_item
*/
...
if (class_exists( 'Vc_Manager' )) {
	...
	*/
	vc_map( array(
		'name' => esc_html__( 'Carousel Slider Item', 'thememountain-plugin' ),
		'base' => 'tm_carousel_slider_item',
		"icon"      => "tm_vc_icon_carousel_slider",
		// 'allowed_container_element' => false,
		'is_container' => true,
		"as_child" => array('only' => 'tm_carousel_slider_holder'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
		...
		'params' => array(
			...
			array(
				'type' => 'textfield',
				'admin_label' => true,
				'heading' => esc_html__( 'Slide Description', 'thememountain-plugin' ),
...
class WPBakeryShortCode_tm_carousel_slider_item extends WPBakeryShortCode_tm_tab_item {
