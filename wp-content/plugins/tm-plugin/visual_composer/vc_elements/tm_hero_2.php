...
if (class_exists( 'Vc_Manager' )) {
	vc_map( array(
		'name' => esc_html__( 'Full Width Hero With Background Image', 'thememountain-plugin' ),
		'category' => esc_html__( 'ThemeMountain', 'thememountain-plugin' ),
		'base' => 'tm_hero_2',
		'icon' => 'tm_vc_icon_hero-2',
		'is_container' => true,
		'show_settings_on_create' => true,
		'description' => esc_html__( 'hero-2', 'thememountain-plugin' ),
		'params' => array(
			array(
				'type' => 'dropdown',
			...
			// Image
			ThemeMountain\TM_Vc::get_image_selector_vc_field('',esc_html__( 'Image', 'thememountain-plugin'),esc_html__( 'Upload hero 2 background image.', 'thememountain-plugin' )),
...
class WPBakeryShortCode_tm_hero_2 extends WPBakeryShortCode {
}
