...
$_output = $_heroContent = '';

extract(shortcode_atts(array(
	'height' => '', // dropdown. small, window_height, auto, custom
...
// css ID
	$_css_id = 'hero-one-'.TM_Shortcodes::tm_serial_number();
...
// add spaces
	...
	$hero_column_offset = ($hero_column_offset !=='') ? " offset-$hero_column_offset" : '';
...
/* Output */
	TM_Shortcodes::output_shortcode_content('hero_section', $_output, "hero-1{$height}" , '', $_args);
