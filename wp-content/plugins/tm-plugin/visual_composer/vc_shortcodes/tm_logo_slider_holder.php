...
$_output = $_sliderContent = $_window_height = $_section_block_id = $_section_inline_style_for_custom_height = $_inline_style_slider_wrapper = $_show_nav_arrows_attr = '';
 ...
 * @var        string
 */
	$_css_id = 'tm_logo_slider-'.TM_Shortcodes::tm_serial_number();
 ...
 * Nav type
 */
	$_show_nav_arrows_attr = ' data-nav-arrows="false"';
 ...
 */
	...
	$_output = "<div class='column width-12'>\n<div class='tm-slider-container logo-slider' data-carousel-visible-slides='{$visible_slides}'{$transition_easing}{$transition_speed}{$_data_nav_show_on_hover}{$auto_advance}{$pause_on_hover}{$auto_advance_interval}{$progress_bar}{$use_pagination}{$_show_nav_arrows_attr}{$use_pagination_attr}>\n<ul class='tms-slides'>\n{$_sliderContent}\n</ul>\n</div>\n</div>\n";
	/* Output */
